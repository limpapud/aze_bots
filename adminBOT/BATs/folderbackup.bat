REM robocopy %Mənbə% %Təyinat% /MOV /LOG:%Log təyinat qovluğu%\BackupLog_%DATE%_%time:~0,2%_%time:~3,2%.Log /minage:7
robocopy D:\from D:\to /MOV /LOG:D:\to\BackupLog_%DATE%_%time:~0,2%_%time:~3,2%.Log /minage:7
